...
do
    #----------------------------------predict length 96---------------------------------------
    python run.py --seed $seed --data electricity_labeled --model $model --moving_avg '13, 17' \
    ...
    #----------------------------------predict length 720---------------------------------------
    python run.py --seed $seed --data electricity_labeled --model $model --batch_size 16 --moving_avg '13, 17' \
